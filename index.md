...
Рума ANONWAVE задумана как место где можно делиться годнотой из мира музыки и приятно чилить. Для соблюдения порядка нужны правила, ознакомься с ними ниже во избежание неприятностей. После этого посмотри, [как искать и добавлять треки](https://i.imgur.com/Id4lWKY.jpg), и [как починить поиск треков из YouTube](https://geodesi2t.github.io/yt-fix). Можешь также ознакомиться с дополнениями для plug.dj.
